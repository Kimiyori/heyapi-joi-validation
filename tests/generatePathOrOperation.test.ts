...
const createTestOperation = (overrides: Partial<OperationData> = {}): OperationData => ({
  method: 'get',
  path: '/test',
  operation: {
    ...createBaseOperation(),
...
describe('generateOperationValidators', () => {
  describe('basic functionality', () => {
    test.each([
      ...
      ['empty parameters', { operation: { ...createBaseOperation(), parameters: {} } }, 0],
      ['null parameters', { operation: { ...createBaseOperation(), parameters: undefined } }, 0],
